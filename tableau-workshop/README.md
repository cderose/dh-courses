...
![Button for New Worksheet](https://github.com/YaleDHLab/humanities-data-mining/blob/master/images/tableauNewWorksheet.png)
...
- Hover on any data point in the dashboard, and the Wikipedia page should automatically update to reflect the country that's selected. ![Dashboard View](https://github.com/YaleDHLab/humanities-data-mining/blob/master/images/tableauDashboard.png)
